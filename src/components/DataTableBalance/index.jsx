...
function DataTableBalance({ balance }) {
    ...
    return (
        <>
            ...
            <DataTable value={balance} filters={filters} globalFilterFields={['description']} emptyMessage="Não foram encontradas recargas" paginator rows={7}  onSelectionChange={(e) => verDetalhes(e.value)}  tableStyle={{ minWidth: '65vw' }}>
