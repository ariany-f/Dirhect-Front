...
function DataTableFiliais({ filiais }) {
    ...
    return (
        <>
            ...
            <DataTable value={filiais} filters={filters} globalFilterFields={['descricao','cnpj']}  emptyMessage="Não foram encontradas filiais" selection={selectedDependente} onSelectionChange={(e) => verDetalhes(e.value)} selectionMode="single" paginator rows={5}  tableStyle={{ minWidth: '68vw' }}>
