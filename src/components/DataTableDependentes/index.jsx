...
function DataTableDependentes({ dependentes }) {
    ...
    return (
        <>
            ...
            <DataTable value={dependentes} filters={filters} globalFilterFields={['pessoa_fisica.nome', 'pessoa_fisica.cpf']}  emptyMessage="Não foram encontrados dependentes" selection={selectedDependente} onSelectionChange={(e) => verDetalhes(e.value)} selectionMode="single" paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]} tableStyle={{ minWidth: '68vw' }}>
