...
import styles from './ModalAdicionarSecao.module.css'
...
function ModalAdicionarSecao({ opened = false, aoClicar, aoFechar, aoSucesso, aoSalvar }) {
                    ...
                    <DialogEstilizado id="modal-add-departamento" open={opened}>
                        <Frame>
                            <Titulo>
                                ...
                                <h6>Criar Seção</h6>
                                <SubTitulo>
                                    Digite o nome da sua nova seção:
                                </SubTitulo>
                            </Titulo>
                        </Frame>
...
export default ModalAdicionarSecao