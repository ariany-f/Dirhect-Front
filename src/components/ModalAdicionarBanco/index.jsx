...
import styles from './ModalAdicionarBanco.module.css';
...
function ModalAdicionarBanco({ opened = false, banco, aoFechar, aoSalvar }) {
    ...
    const validarESalvar = () => {
        ...
        // Se tem banco, está editando, senão está adicionando
        if (banco) {
                    ...
                    <DialogEstilizado open={opened}>
                        <Frame>
                            <Titulo>
                                ...
                                <h6>{banco ? 'Editar Calendário' : 'Novo Calendário'}</h6>
                            </Titulo>
                        </Frame>
                        ...
                        <Wrapper>
                            ...
                            <Botao
                                ...
                                filled
                            >
                                {banco ? 'Salvar Alterações' : 'Salvar Calendário'}
                            </Botao>
                        </Wrapper>
                    </DialogEstilizado>
                </Overlay>
...
export default ModalAdicionarBanco;