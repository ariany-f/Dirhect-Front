...
function DataTableFuncoes({ funcoes, showSearch = true, paginator = true, rows = 10, totalRecords, totalPages, first, onPage, onSearch, selected = null, setSelected = () => { }, onUpdate, sortField, sortOrder, onSort }) {
    ...
    const exibeColunasOpcionais = {
        ...
        integracao: ((metadadosDeveSerExibido || bulkIntegrationMode) && ArmazenadorToken.hasPermission('change_funcao'))
    };
    ...
    const representativeActionsTemplate = (rowData) => {
        return (
            <div style={{ 
                ...
                {ArmazenadorToken.hasPermission('change_funcao') && !bulkIntegrationMode && !metadadosDeveSerExibido && (
                <FaPen 
                    className="edit" 
    ...
    return (
        <>
            ...
            >
                ...
                <Column body={representativeDetalhesTemplate} header="Descrição" sortable style={{ width: `${largurasColunas[getColumnIndex(4)]}%` }}></Column>
