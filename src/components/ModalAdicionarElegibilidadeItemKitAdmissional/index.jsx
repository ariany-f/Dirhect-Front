...
function ModalAdicionarElegibilidadeItemKitAdmissional({ opened = false, aoFechar, aoSalvar, item }) {
    ...
    // Adicione este useEffect no componente ModalAdicionarElegibilidadeItemKitAdmissional
    useEffect(() => {
                ...
                <Frame>
                    <Titulo>
                        <BotaoGrupo align="space-between">
                            <h6>Grupos Elegíveis a {item?.descricao ? item?.descricao : 'este item de Kit Admissional'} <small style={{fontSize: 12, color: 'var(--neutro-800)', fontWeight: 400}}>{item?.versao ? `V. ${item?.versao}` : ''}</small></h6>
                        </BotaoGrupo>
...
export default ModalAdicionarElegibilidadeItemKitAdmissional;