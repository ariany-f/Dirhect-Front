...
export const DependentesContext = createContext({
...
export const useDependentesContext = () => {
    return useContext(DependentesContext);
}

export const DependentesProvider = ({ children }) => {
    ...
    return (<DependentesContext.Provider value={contexto}>
        {children}
