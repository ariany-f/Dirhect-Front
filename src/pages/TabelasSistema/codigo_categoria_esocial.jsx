...
function CodigoCategoriaEsocial() {
    ...
    const carregarDados = async () => {
        try {
            setLoading(true);
            const response = await http.get('tabela_dominio/codigo_categoria_esocial/');
    ...
    return (
        <ConteudoFrame>
            ...
            <TabelasSistemaNavigation currentPath="/tabelas-de-sistema/codigo-categoria-esocial" />
...
export default CodigoCategoriaEsocial;
