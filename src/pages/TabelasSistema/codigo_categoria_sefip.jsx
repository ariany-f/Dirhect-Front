...
function CodigoCategoriaSefip() {
    ...
    const carregarDados = async () => {
        try {
            setLoading(true);
            const response = await http.get('tabela_dominio/codigo_categoria_sefip/');
    ...
    return (
        <ConteudoFrame>
            ...
            <TabelasSistemaNavigation currentPath="/tabelas-de-sistema/codigo-categoria-sefip" />
...
export default CodigoCategoriaSefip;
