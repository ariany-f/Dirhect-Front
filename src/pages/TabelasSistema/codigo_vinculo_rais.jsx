...
function CodigoVinculoRais() {
    ...
    const carregarDados = async () => {
        try {
            setLoading(true);
            const response = await http.get('tabela_dominio/codigo_vinculo_rais/');
    ...
    return (
        <ConteudoFrame>
            ...
            <TabelasSistemaNavigation currentPath="/tabelas-de-sistema/codigo-vinculo-rais" />
            
            <Container>
                <DataTable
                    value={dados}
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                    currentPageReportTemplate="Mostrando {first} até {last} de {totalRecords} codigo-vinculo-rais"
                    loading={loading}
                    header={header}
                    filters={filters}
...
export default CodigoVinculoRais;
