...
function TipoBairro() {
    ...
    const carregarDados = async () => {
        try {
            setLoading(true);
            const response = await http.get('tabela_dominio/tipo_bairro/');
    ...
    return (
        <ConteudoFrame>
            ...
            <TabelasSistemaNavigation currentPath="/tabelas-de-sistema/tipo-bairro" />
            
            <Container>
                <DataTable
                    value={dados}
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                    currentPageReportTemplate="Mostrando {first} até {last} de {totalRecords} tipo-bairro"
                    loading={loading}
                    header={header}
                    filters={filters}
