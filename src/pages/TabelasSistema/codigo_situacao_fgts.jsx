...
function CodigoSituacaoFgts() {
    ...
    const carregarDados = async () => {
        try {
            setLoading(true);
            const response = await http.get('tabela_dominio/codigo_situacao_fgts/');
    ...
    return (
        <ConteudoFrame>
            ...
            <TabelasSistemaNavigation currentPath="/tabelas-de-sistema/codigo-situacao-fgts" />
...
export default CodigoSituacaoFgts;
