...
function CodigoOcorrenciaSefip() {
    ...
    const carregarDados = async () => {
        try {
            setLoading(true);
            const response = await http.get('tabela_dominio/codigo_ocorrencia_sefip/');
    ...
    return (
        <ConteudoFrame>
            ...
            <TabelasSistemaNavigation currentPath="/tabelas-de-sistema/codigo-ocorrencia-sefip" />
            
            <Container>
                <DataTable
                    value={dados}
                    paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                    currentPageReportTemplate="Mostrando {first} até {last} de {totalRecords} codigo-ocorrencia-sefip"
                    loading={loading}
                    header={header}
                    filters={filters}
...
export default CodigoOcorrenciaSefip;
