            ...
            <BotaoGrupo align="space-between">
                <BotaoGrupo>
                    <Link to={`/estrutura/sindicato/detalhes/${id}`}>
                        <Botao estilo={location.pathname == `/estrutura/sindicato/detalhes/${id}`?'black':''} size="small" tab>Colaboradores</Botao>
                    </Link>
                    <Link to={`/estrutura/sindicato/detalhes/${id}/configuracao-beneficios`}>
                        <Botao estilo={location.pathname == `/estrutura/sindicato/detalhes/${id}/configuracao-beneficios`?'black':''} size="small" tab>Configuração de Benefícios</Botao>
                    </Link>
                </BotaoGrupo>
