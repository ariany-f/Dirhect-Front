            ...
            <BotaoGrupo align="space-between">
                <BotaoGrupo>
                    <Link to={`/estrutura/filial/detalhes/${id}`}>
                        <Botao estilo={location.pathname == `/estrutura/filial/detalhes/${id}`?'black':''} size="small" tab>Configuração de Benefícios</Botao>
                    </Link>
                    <Link to={`/estrutura/filial/detalhes/${id}/adicionar-colaboradores`}>
                        <Botao estilo={location.pathname == `/estrutura/filial/detalhes/${id}/adicionar-colaboradores`?'black':''} size="small" tab>Colaboradores</Botao>
                    </Link>
                </BotaoGrupo>
                
                {location.pathname == `/estrutura/filial/detalhes/${id}/adicionar-colaboradores` &&
                    <></>
                }
