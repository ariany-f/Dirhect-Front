                    ...
                    <Stepper headerPosition="top" ref={stepperRef} style={{ flexBasis: '50rem' }}>
                        <StepperPanel>
                            ...
                            <Frame padding="30px" alinhamento="end">
                                <Botao label="Next" iconPos="right" aoClicar={() => {recarga.name ? stepperRef.current.nextCallback() : toast.current.show({severity: 'info', detail: 'Preencha o nome do Pedido', life: 15000})}}><HiArrowRight fill="white"/> Continuar</Botao>
                            </Frame>
                        </StepperPanel>
                        <StepperPanel>
                            <Titulo>
